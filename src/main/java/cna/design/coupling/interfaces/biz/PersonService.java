...
import cna.design.coupling.interfaces.data.PersonEntity;
import cna.design.coupling.interfaces.data.PersonEntityAlreadyExistException;
import cna.design.coupling.interfaces.data.PersonEntityDao;
...
public class PersonService {
    ...
    public PersonService(PersonEntityDao personEntityDao) {
